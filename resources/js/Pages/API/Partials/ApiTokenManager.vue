...
import ActionMessage from '@/Inertia/ActionMessage.vue';
import ActionSection from '@/Inertia/ActionSection.vue';
import Checkbox from '@/Inertia/Checkbox.vue';
import ConfirmationModal from '@/Inertia/ConfirmationModal.vue';
import DangerButton from '@/Inertia/DangerButton.vue';
import DialogModal from '@/Inertia/DialogModal.vue';
import FormSection from '@/Inertia/FormSection.vue';
import InputError from '@/Inertia/InputError.vue';
import InputLabel from '@/Inertia/InputLabel.vue';
import PrimaryButton from '@/Inertia/PrimaryButton.vue';
import SecondaryButton from '@/Inertia/SecondaryButton.vue';
import SectionBorder from '@/Inertia/SectionBorder.vue';
